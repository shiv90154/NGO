        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-white font-semibold text-lg">SAMRADDH BHARAT</span>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:18001234567" className="hover:text-white">1800-123-4567 (Toll Free)</a>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[#ff8c42]">✉️</span>
                <a href="mailto:support@samraddhbharat.gov.in" className="hover:text-white">support@samraddhbharat.gov.in</a>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[#ff8c42]">📍</span>
                <span>Samraddh Bharat Foundation,<br />New Delhi - 110001, India</span>
              </div>
            </div>
            <div className="mt-4 flex gap-4">
              {['📘', '🐦', '📷', '🔗'].map((icon, idx) => (
                <a
                  key={idx}
                  href="#"
                  className="w-8 h-8 rounded-full bg-gray-700 hover:bg-[#ff8c42] flex items-center justify-center text-white transition-colors duration-200"
                >
                  {icon}
                </a>
              ))}
